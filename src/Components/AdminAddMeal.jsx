  ...
  return (
    <section className="bg-white rounded-3xl shadow-lg p-8">
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <input type="text" placeholder="Image URL" className="border p-3 rounded-xl focus:ring-2 ring-black" />
          ...
          <button className="px-6 py-3 bg-black text-white border-2 border-black outline outline-4 outline-offset-4 rounded-xl hover:bg-gray-800 transition md:col-span-2">
            Add Meal
          </button>
        </form>
      </section>
